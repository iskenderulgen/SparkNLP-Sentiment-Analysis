...
public class Bike {
	...
	public Bike(Long id, String maritalStatus, String gender,
			Float yearlyIncome, Integer totalChildren, String education,
			String occupation, String houseOwner, Integer numberCarsOwned,
			String commuteDistance, String region, Integer age, String bikeBuyer) {
		super();
		this.id = id;
	...
	public Bike(String... row) {
		this(Long.parseLong(row[0]), row[1], row[2], Float.parseFloat(row[3]),
				Integer.parseInt(row[4]), row[5], row[6], row[7], Integer
						.parseInt(row[8]), row[9], row[10], Integer
						.parseInt(row[11]), row[12]);
	}
	...
	public void setBikeBuyer(String bikeBuyer) {
		this.bikeBuyer = bikeBuyer;
	}
}
